...
const WaitCheck: React.FC<IWaitCheckProps> = (props) => {
  ...
  const columns = useMemo<ProColumns<AppType>[]>(
    () => [
      ...
      { title: '类别名称', align: 'center', key: 'typeName', dataIndex: 'typeName' },
      { title: '持有者', align: 'center', key: 'typeName', dataIndex: 'typeName' },
      { title: '应用类型', align: 'center', key: 'typeName', dataIndex: 'typeName' },
      { title: '图标', align: 'center', key: 'typeName', dataIndex: 'typeName', renderFormItem: () => { return null }, },
      { title: '短描述', align: 'center', key: 'typeName', dataIndex: 'typeName', renderFormItem: () => { return null }, },
      { title: '应用状态', align: 'center', key: 'appStatus', dataIndex: 'appStatus', valueEnum: appStatusEnum },
      { title: '是否上推荐', align: 'center', key: 'typeName', dataIndex: 'typeName' },
      { title: '是否在推荐页隐藏', align: 'center', key: 'typeName', dataIndex: 'typeName' },
      {
        ...
        render: (node, row) => {
          return <>
            {props.tabType === 'waitCheck' && <>
              <Button type="link" onClick={() => setIfCheck('check')}>审核</Button>
            </>}
